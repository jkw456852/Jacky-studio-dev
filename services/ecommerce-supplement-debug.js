...
exports.persistEcommerceSupplementDebugSnapshot = void 0;
var shouldPersistEcommerceSupplementDebugSnapshot = function () {
    if (typeof window === "undefined")
        return false;
    var host = String(window.location.hostname || "").toLowerCase();
    return host === "localhost" || host === "127.0.0.1" || host === "0.0.0.0";
};
var persistEcommerceSupplementDebugSnapshot = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 6, , 7]);
                return [4 /*yield*/, fetch("/api/debug-ecommerce-supplement", {
                        method: "POST",
                        headers: {
...
exports.persistEcommerceSupplementDebugSnapshot = persistEcommerceSupplementDebugSnapshot;
