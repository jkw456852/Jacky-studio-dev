...
export const SHARED_CORE_PLANNING_BRAIN = `# Shared Core Brain
...
export const SHARED_DELIVERABLE_DECOMPOSITION_BRAIN = `# Shared Deliverable Decomposition
...
export const SHARED_PLANNING_SELF_CHECK_BRAIN = `# Shared Planning Self-Check
...
export const SHARED_UNIFIED_AGENT_BRAIN = `
${SHARED_CORE_PLANNING_BRAIN}

${SHARED_DELIVERABLE_DECOMPOSITION_BRAIN}

${SHARED_PLANNING_SELF_CHECK_BRAIN}
