...
export interface BuildBrowserToolRecipeCapabilityInput {
  id: string;
  label: string;
...
export const buildBrowserToolRecipeCapability = (
  input: BuildBrowserToolRecipeCapabilityInput,
): RecipeCapabilityDefinition => ({
  id: input.id,
  label: input.label,
  domain: input.domain,
  ...
  runtimeAvailability: input.runtimeAvailability || 'conditional',
