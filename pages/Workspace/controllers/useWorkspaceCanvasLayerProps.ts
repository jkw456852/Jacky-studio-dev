...
export const useWorkspaceCanvasLayerProps = ({
  ...
  > = {
    ...
    onSetCurrentAsAnchor: () =>
      handleSetConsistencyAnchorFromElement(selectedElement),
    onPreviewCurrentAnchor: handlePreviewConsistencyAnchor,
    onFastEdit: () => setShowFastEdit(true),
    onOpenUpscalePanel: () => setShowUpscalePanel(true),
    onRemoveBg: handleRemoveBg,
    onOpenProductSwapPanel: () => setShowProductSwapPanel(true),
    setSelectedElementId,
    setSelectedElementIds,
    handleRefImageUpload,
    handleGenImage,
